...
# Sum the values and display relevant information
gross_pay = hourly_rate * regular_hours + overtime_rate * overtime_hours
deductions = electric_p * gross_pay + water_p * gross_pay + gas_p * gross_pay + \
             food + entertainment + car
print("\nMonthly Expenses")
print("Electric: $", electric_p * gross_pay)
print("Water: $", water_p * gross_pay)
print("Gas: $", gas_p * gross_pay)
print("Food: $", food)
print("Entertainment: $", entertainment)
print("Car Expenses: $", car)
print("\nTotal Deductions: $", deductions)
print("Gross Pay: $", gross_pay)
print("Net Pay: $", gross_pay - deductions)
